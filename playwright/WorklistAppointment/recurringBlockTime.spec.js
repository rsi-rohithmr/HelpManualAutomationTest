...
test.describe.serial('Recurring Block Time', async () => {
	test.beforeAll(async () => {
		...
		singleBlockNote = `Recurring Block Note ${randomNum}`;

		poManager = new POManager(page);
		await poManager.loginPage.loginOmegaAI();
	});

	test('Create a recurring block successfully', async () => {
	...
	test('Update a recurring block successfully', async () => {
